...
class ComputationalGraph:
    ...
    def ComputeGradient(self,lastIndex = -1):
        ...
        INPUT 
        =====
        LastIndex : This is the index of the final functional which we are going to evaluate, for univariate scalar function, it will always be -1
        (the last index)

        For vector functions, the last index will be the index for each function in the array.
        '''
    ...
    def WIPER(self,D):
        """
        This function serves to clear up all values and deris in the graph for reuse when evaluating a series of value
    ...
    def SeriesValues(self,C,D, Graph):
        ...
        NOTE
        =====
        This function calculates the deris and values for a series of variables 
        
        INPUT
        =====
        C : The array of values that the user would like to evaluate 
        D : The total number of variables that the user would like to evaluate 


        RETURN
        ======
        The list of values and derivatives for these series of values in np.array form
